...
Vi har selv blot kompileret med GNU's Compiler Collection (GCC). Derfor kompilerede med koden: `gcc p1-groupSorting.c`
...
Det første programmet gør hvis et dataset er lagt med programmet, er at spørge om hvor mange elever der er i sættet, efterfulgt af hvor mange elever der max må være i hver gruppe (helst mellem 4-6, da dette er størelsen på grupper foreslået af Belbin).
